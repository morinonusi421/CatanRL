...
class catanBoard(hexTile, Vertex):
    ...
    def __init__(self,fixed=False):
        ...
        if fixed:
            self.resourcesList = self.getFixedResourceList()
        else:
        ...
        if fixed:
            randomIndices = [i for i in range(19)]
        ...
        if fixed:
            self.fixedUpdatePorts() #Add the ports to the graph
        else:
            self.updatePorts()
    ...
    def getFixedResourceList(self):
        resourceList = [Resource("ORE",i+1) for i in range(19)]
        resourceList = [Resource("DESERT",None),
                        Resource("ORE",4),Resource("WHEAT",5),Resource("ORE",6),
                        Resource("WOOD",3),Resource("ORE",11),Resource("BRICK",9),
                        Resource("WOOD",6),Resource("SHEEP",3),Resource("SHEEP",8),
                        Resource("WOOD",10),Resource("WHEAT",9),Resource("SHEEP",12),
                        Resource("BRICK",11),Resource("SHEEP",4),Resource("BRICK",8),
                        Resource("WHEAT",10),Resource("WOOD",5),Resource("WHEAT",2),
                        ]
    ...
    def fixedUpdatePorts(self):
        

        port_dict = {'2:1 BRICK': [38,39], '2:1 SHEEP': [28,29], '2:1 WOOD': [40,44], '2:1 WHEAT': [48,49], '2:1 ORE': [50,53], 
                     '3:1 PORT': [26,25,32,33,35,37,46,47]}
